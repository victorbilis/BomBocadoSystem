 ...
 * @author i14584i
 */
public class add_estoque extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            func.execute("INSERT INTO estoque VALUES(null,'" + nome + "','" + preco + "'," + qtd + ",'" + desc + "');", "INSERT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_estoque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_estoque().setVisible(true);
            }
        });
    }
