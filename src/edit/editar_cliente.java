...
public class editar_cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/edituser_icon.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 10, 140, -1));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            String cel = jFormattedTextField2.getText();
           
            func.send("UPDATE cliente SET nome_cli='" + nome + "',tel_res='" + tel + "',tel_cel='" + cel + "' WHERE cod_cli=" + id + ";");
