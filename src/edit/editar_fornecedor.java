...
public class editar_fornecedor extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            String outros = jTextArea1.getText();
            func.execute("UPDATE forn SET forn_nome='" + nome + "',forn_end='" + end + "',forn_tel='" + tel + "',forn_email='" + email + "',forn_contatos='" + outros + "' WHERE forn_cod=" + id + ";", "INSERT");
