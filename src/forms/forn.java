...
import edit.editar_fornecedor;
import add.add_forn;
import visualizar.vs_fornecedor;
...
public class forn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 30, 470, -1));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 290, 90, 50));
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        if (res == 0) {
            try {
                ...
                func.execute("DELETE FROM forn WHERE forn_cod='" + cod + "';", "INSERT");
    ...
    public void atualizar() {
        ...
        lista.addColumn("Email");
        lista.addColumn("Outros contatos");
        functions func = new functions();
        ResultSet rs = func.execute("SELECT * FROM forn ORDER BY forn_nome ASC;", "SELECT");
        try {
            while (rs.next()) {
                int cod = rs.getInt("forn_cod");
                String nome = rs.getString("forn_nome");
                String end = rs.getString("forn_end");
                String tel = rs.getString("forn_tel");
                String email = rs.getString("forn_email");
                String contatos = rs.getString("forn_contatos");
                String[] dados = {"" + cod, nome, end, tel, email, contatos};
                lista.addRow(dados);
            }
        } catch (Exception e) {
            System.out.println("" + e);
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        if (var.equals("sim")) {
            ...
            editar_fornecedor frm = new editar_fornecedor();
            frm.id = selecionado;
            frm.setVisible(true);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Por favor, selecione um fornecedor para poder editar.");
        }
    ...
    private void txt_pesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_pesquisarKeyReleased
        ...
        if (qtd >= 1) {
            ...
            ResultSet rs = func.execute("SELECT * FROM forn WHERE forn_cod LIKE \"%" + txt_pesquisar.getText() + "%\" OR forn_nome LIKE \"%" + txt_pesquisar.getText() + "%\" OR forn_end LIKE \"%" + txt_pesquisar.getText() + "%\" OR forn_tel LIKE \"%" + txt_pesquisar.getText() + "%\" OR forn_email=\"" + txt_pesquisar.getText() + "\" OR forn_contatos=\"" + txt_pesquisar.getText() + "\"", "SELECT");
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ...
        if (var.equals("sim")) {
            int selecionado = Integer.parseInt(jTable1.getValueAt(linha, 0).toString());
            vs_fornecedor frm = new vs_fornecedor();
            frm.id = selecionado;
            frm.setVisible(true);
            this.dispose();
        } else {
